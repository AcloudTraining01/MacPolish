# MacPolish — Claude Agent Context

This file is read by Claude Code (and other Claude-based agents) on every session in this repo. Keep it tight: project context, key decisions, where to find things, how to build and test.
